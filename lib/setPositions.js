...
class SetPositions {
    ...
    setSetpiece(matchDetails, team, opposition) {
        return new Promise((resolve, reject) => {
            ...
            if (team.players[0].originPOS[1] > matchDetails.pitchSize[1] / 2) {
                if (Common_1.Common.isBetween(ballPosition[0], (matchDetails.pitchSize[0] / 4) - 5, matchDetails.pitchSize[0] - (matchDetails.pitchSize[0] / 4) + 5) && Common_1.Common.isBetween(ballPosition[1], 0, (matchDetails.pitchSize[1] / 6) - 5)) {
                ...
                if (Common_1.Common.isBetween(ballPosition[0], (matchDetails.pitchSize[0] / 4) - 5, matchDetails.pitchSize[0] - (matchDetails.pitchSize[0] / 4) + 5) && Common_1.Common.isBetween(ballPosition[1], matchDetails.pitchSize[1] - (matchDetails.pitchSize[1] / 6) + 5, matchDetails.pitchSize[1])) {
        ...
        return new Promise((resolve, reject) => {
            ...
            if (side === "top") {
                ...
                if (ballPosition[1] > (matchDetails.pitchSize[1] - (matchDetails.pitchSize[1] / 3))) {
                    ...
                    const level = Common_1.Common.getRandomNumber(matchDetails.pitchSize[1] / 2, 200);
                    ...
                    const level = Math.round(Common_1.Common.getRandomNumber((matchDetails.pitchSize[1] / 9), ballPosition[1] + 15));
                    ...
                    team.players[7].startPOS = [team.players[7].originPOS[0], level];
                    team.players[8].startPOS = [team.players[8].originPOS[0], level];
                    team.players[9].startPOS = [team.players[9].originPOS[0], Common_1.Common.getRandomNumber(5, level - 20)];
                    team.players[10].startPOS = [team.players[10].originPOS[0], Common_1.Common.getRandomNumber(5, level - 20)];
                    if (ballPosition[0] > matchDetails.pitchSize[0] / 2) {
                        matchDetails.ball.direction = "northwest";
                    ...
                    team.players[1].startPOS = [Common_1.Common.getRandomNumber((matchDetails.pitchSize[0] / 4) - 5, (matchDetails.pitchSize[0] - (matchDetails.pitchSize[0] / 4) + 5)), Common_1.Common.getRandomNumber(0, (matchDetails.pitchSize[1] / 6) - 5)];
                    team.players[4].startPOS = [Common_1.Common.getRandomNumber((matchDetails.pitchSize[0] / 4) - 5, (matchDetails.pitchSize[0] - (matchDetails.pitchSize[0] / 4) + 5)), Common_1.Common.getRandomNumber(0, (matchDetails.pitchSize[1] / 6) - 5)];
                    team.players[6].startPOS = [Common_1.Common.getRandomNumber((matchDetails.pitchSize[0] / 4) - 5, (matchDetails.pitchSize[0] - (matchDetails.pitchSize[0] / 4) + 5)), Common_1.Common.getRandomNumber(0, (matchDetails.pitchSize[1] / 6) - 5)];
                    team.players[7].startPOS = [Common_1.Common.getRandomNumber((matchDetails.pitchSize[0] / 4) - 5, (matchDetails.pitchSize[0] - (matchDetails.pitchSize[0] / 4) + 5)), Common_1.Common.getRandomNumber(0, (matchDetails.pitchSize[1] / 6) - 5)];
                    team.players[8].startPOS = [Common_1.Common.getRandomNumber((matchDetails.pitchSize[0] / 4) - 5, (matchDetails.pitchSize[0] - (matchDetails.pitchSize[0] / 4) + 5)), Common_1.Common.getRandomNumber(0, (matchDetails.pitchSize[1] / 6) - 5)];
                    team.players[9].startPOS = [Common_1.Common.getRandomNumber((matchDetails.pitchSize[0] / 4) - 5, (matchDetails.pitchSize[0] - (matchDetails.pitchSize[0] / 4) + 5)), Common_1.Common.getRandomNumber(0, (matchDetails.pitchSize[1] / 6) - 5)];
                    team.players[10].startPOS = [Common_1.Common.getRandomNumber((matchDetails.pitchSize[0] / 4) - 5, (matchDetails.pitchSize[0] - (matchDetails.pitchSize[0] / 4) + 5)), Common_1.Common.getRandomNumber(0, (matchDetails.pitchSize[1] / 6) - 5)];
                    ...
                    if (ballPosition[0] > matchDetails.pitchSize[0] / 2) {
                        ...
                        opposition.players[8].startPOS = [Common_1.Common.getRandomNumber((matchDetails.pitchSize[0] / 4) - 5, (matchDetails.pitchSize[0] - (matchDetails.pitchSize[0] / 4) + 5)), Common_1.Common.getRandomNumber(0, (matchDetails.pitchSize[1] / 6) - 5)];
                        opposition.players[9].startPOS = [Common_1.Common.getRandomNumber((matchDetails.pitchSize[0] / 4) - 5, (matchDetails.pitchSize[0] - (matchDetails.pitchSize[0] / 4) + 5)), Common_1.Common.getRandomNumber(0, (matchDetails.pitchSize[1] / 6) - 5)];
                        ...
                        opposition.players[5].startPOS = [Common_1.Common.getRandomNumber((matchDetails.pitchSize[0] / 4) - 5, (matchDetails.pitchSize[0] - (matchDetails.pitchSize[0] / 4) - 5)), Common_1.Common.getRandomNumber(0, (matchDetails.pitchSize[1] / 6) - 5)];
                        opposition.players[9].startPOS = [Common_1.Common.getRandomNumber((matchDetails.pitchSize[0] / 4) - 5, (matchDetails.pitchSize[0] - (matchDetails.pitchSize[0] / 4) - 5)), Common_1.Common.getRandomNumber(0, (matchDetails.pitchSize[1] / 6) - 5)];
                        opposition.players[10].startPOS = [matchDetails.pitchSize[0] / 2, 20];
                    }
                    else {
                ...
                if (ballPosition[1] < (matchDetails.pitchSize[1] / 3)) {
                    ...
                    const level = Common_1.Common.getRandomNumber(matchDetails.pitchSize[1] / 2, matchDetails.pitchSize[1] - 200);
                    team.players[1].startPOS = [team.players[1].originPOS[0], team.players[5].startPOS[1] - (matchDetails.pitchSize[1] / 6)];
                    team.players[2].startPOS = [team.players[2].originPOS[0], team.players[5].startPOS[1] - (matchDetails.pitchSize[1] / 6)];
                    team.players[3].startPOS = [team.players[3].originPOS[0], team.players[5].startPOS[1] - (matchDetails.pitchSize[1] / 6)];
                    team.players[4].startPOS = [team.players[4].originPOS[0], team.players[5].startPOS[1] - (matchDetails.pitchSize[1] / 6)];
                    ...
                    //between halfway and last sixth
                    const level = Math.round(Common_1.Common.getRandomNumber(ballPosition[1] + 15, (matchDetails.pitchSize[1] - matchDetails.pitchSize[1] / 9)));
                    team.players[0].startPOS = [team.players[0].originPOS[0], team.players[5].startPOS[1] - (matchDetails.pitchSize[1] / 3)];
                    team.players[1].startPOS = [team.players[1].originPOS[0], team.players[5].startPOS[1] - (matchDetails.pitchSize[1] / 6)];
                    team.players[2].startPOS = [team.players[2].originPOS[0], team.players[5].startPOS[1] - (matchDetails.pitchSize[1] / 6)];
                    team.players[3].startPOS = [team.players[3].originPOS[0], team.players[5].startPOS[1] - (matchDetails.pitchSize[1] / 6)];
                    ...
                    team.players[2].startPOS = [team.players[2].originPOS[0], team.players[2].originPOS[1] + (matchDetails.pitchSize[1] / 2)];
                    team.players[3].startPOS = [team.players[3].originPOS[0], team.players[3].originPOS[1] + (matchDetails.pitchSize[1] / 2)];
                    team.players[1].startPOS = [Common_1.Common.getRandomNumber((matchDetails.pitchSize[0] / 4) - 5, (matchDetails.pitchSize[0] - (matchDetails.pitchSize[0] / 4) + 5)), Common_1.Common.getRandomNumber(matchDetails.pitchSize[1] - (matchDetails.pitchSize[1] / 6) + 5, matchDetails.pitchSize[1])];
                    team.players[4].startPOS = [Common_1.Common.getRandomNumber((matchDetails.pitchSize[0] / 4) - 5, (matchDetails.pitchSize[0] - (matchDetails.pitchSize[0] / 4) + 5)), Common_1.Common.getRandomNumber(matchDetails.pitchSize[1] - (matchDetails.pitchSize[1] / 6) + 5, matchDetails.pitchSize[1])];
                    team.players[6].startPOS = [Common_1.Common.getRandomNumber((matchDetails.pitchSize[0] / 4) - 5, (matchDetails.pitchSize[0] - (matchDetails.pitchSize[0] / 4) + 5)), Common_1.Common.getRandomNumber(matchDetails.pitchSize[1] - (matchDetails.pitchSize[1] / 6) + 5, matchDetails.pitchSize[1])];
                    team.players[7].startPOS = [Common_1.Common.getRandomNumber((matchDetails.pitchSize[0] / 4) - 5, (matchDetails.pitchSize[0] - (matchDetails.pitchSize[0] / 4) + 5)), Common_1.Common.getRandomNumber(matchDetails.pitchSize[1] - (matchDetails.pitchSize[1] / 6) + 5, matchDetails.pitchSize[1])];
                    team.players[8].startPOS = [Common_1.Common.getRandomNumber((matchDetails.pitchSize[0] / 4) - 5, (matchDetails.pitchSize[0] - (matchDetails.pitchSize[0] / 4) + 5)), Common_1.Common.getRandomNumber(matchDetails.pitchSize[1] - (matchDetails.pitchSize[1] / 6) + 5, matchDetails.pitchSize[1])];
                    team.players[9].startPOS = [Common_1.Common.getRandomNumber((matchDetails.pitchSize[0] / 4) - 5, (matchDetails.pitchSize[0] - (matchDetails.pitchSize[0] / 4) + 5)), Common_1.Common.getRandomNumber(matchDetails.pitchSize[1] - (matchDetails.pitchSize[1] / 6) + 5, matchDetails.pitchSize[1])];
                    team.players[10].startPOS = [Common_1.Common.getRandomNumber((matchDetails.pitchSize[0] / 4) - 5, (matchDetails.pitchSize[0] - (matchDetails.pitchSize[0] / 4) + 5)), Common_1.Common.getRandomNumber(matchDetails.pitchSize[1] - (matchDetails.pitchSize[1] / 6) + 5, matchDetails.pitchSize[1])];
                    ...
                    if (ballPosition[0] > matchDetails.pitchSize[0] / 2) {
                        ...
                        opposition.players[8].startPOS = [Common_1.Common.getRandomNumber((matchDetails.pitchSize[0] / 4) - 5, (matchDetails.pitchSize[0] - (matchDetails.pitchSize[0] / 4) + 5)), Common_1.Common.getRandomNumber(matchDetails.pitchSize[1] - (matchDetails.pitchSize[1] / 6) + 5, matchDetails.pitchSize[1])];
                        opposition.players[9].startPOS = [Common_1.Common.getRandomNumber((matchDetails.pitchSize[0] / 4) - 5, (matchDetails.pitchSize[0] - (matchDetails.pitchSize[0] / 4) + 5)), Common_1.Common.getRandomNumber(matchDetails.pitchSize[1] - (matchDetails.pitchSize[1] / 6) + 5, matchDetails.pitchSize[1])];
                        ...
                        opposition.players[5].startPOS = [Common_1.Common.getRandomNumber((matchDetails.pitchSize[0] / 4) - 5, (matchDetails.pitchSize[0] - (matchDetails.pitchSize[0] / 4) + 5)), Common_1.Common.getRandomNumber(matchDetails.pitchSize[1] - (matchDetails.pitchSize[1] / 6) + 5, matchDetails.pitchSize[1])];
                        opposition.players[9].startPOS = [Common_1.Common.getRandomNumber((matchDetails.pitchSize[0] / 4) - 5, (matchDetails.pitchSize[0] - (matchDetails.pitchSize[0] / 4) + 5)), Common_1.Common.getRandomNumber(matchDetails.pitchSize[1] - (matchDetails.pitchSize[1] / 6) + 5, matchDetails.pitchSize[1])];
                        opposition.players[10].startPOS = [matchDetails.pitchSize[0] / 2, matchDetails.pitchSize[1] + 20];
                    }
                    else {
        ...
        return new Promise((resolve, reject) => {
            setVariables.resetPlayerPositions(scoringTeam).then(() => {
                setVariables.resetPlayerPositions(conceedingTeam).then(() => {
                    let playerWithBall = Common_1.Common.getRandomNumber(9, 10);
                    let waitingPlayer;
                    if (playerWithBall === 9) {
                        waitingPlayer = 10;
                    }
    ...
    keepInBoundaries(ballIntended, kickersSide, matchDetails, kickOffTeam, secondTeam) {
        return new Promise((resolve, reject) => {
            if (ballIntended[0] < 0 || ballIntended[0] > matchDetails.pitchSize[0] || ballIntended[1] < 0 || ballIntended[1] > matchDetails.pitchSize[1]) {
            ...
            else if (Common_1.Common.isBetween(ballIntended[0], (matchDetails.pitchSize[0] / 2) - 20, (matchDetails.pitchSize[0] / 2) + 20)) {
                this.closestPlayerToPosition("none", kickOffTeam, ballIntended).then((playerInformationA) => {
                    this.closestPlayerToPosition("none", secondTeam, ballIntended).then((playerInformationB) => {
                        let piA = playerInformationA;
                        let piB = playerInformationB;
     ...
     * @returns {Promise<any>}
     */
    formationTeamBSetPenalty(_team, _tempArray, _shootArray) {
        return new Promise((resolve, reject) => {
     ...
     * @returns {Promise<any>}
     */
    formationTeamASetPenalty(_team, _tempArray) {
        return new Promise(((resolve, reject) => {

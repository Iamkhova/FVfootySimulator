...
class SetPositions {
    ...
    setSetpiece(matchDetails, team, opposition) {
        return new Promise((resolve, reject) => {
            ...
            if (team.players[0].originPOS[1] > matchDetails.pitchSize[1] / 2) {
                if (common_1.Common.isBetween(ballPosition[0], (matchDetails.pitchSize[0] / 4) - 5, matchDetails.pitchSize[0] - (matchDetails.pitchSize[0] / 4) + 5) && common.isBetween(ballPosition[1], 0, (matchDetails.pitchSize[1] / 6) - 5)) {
                ...
                if (common_1.Common.isBetween(ballPosition[0], (matchDetails.pitchSize[0] / 4) - 5, matchDetails.pitchSize[0] - (matchDetails.pitchSize[0] / 4) + 5) && common.isBetween(ballPosition[1], matchDetails.pitchSize[1] - (matchDetails.pitchSize[1] / 6) + 5, matchDetails.pitchSize[1])) {
